  ...
  <div class="container">
    <nav class="navbar navbar-default" role="navigation"> 
      ...
      <div class="navbar-header">
        <h1 class="navbar-brand"><a href="index.php">University<span>Info</span></a></h1>
  ...
  <div class="row" style="padding:0px;">
      ...
      <div class="row" style="padding:0px">
        <div class="col-md-12">
          ...
          <div class="content-box-large box-with-header">
            ...
            <div class="row" style="padding:0px;">
              <div class="col-md-12">
                <p class="small mt" text-align='center'>MEMBER SINCE</p>
                <p>2019</p>
              </div>
              <div class="col-md-6">
                <p class="small mt"> </p>
     ...
     <div class="row" style="padding:0px">
        <div class="col-md-12">
          ...
          <div class="content-box-large box-with-header">
            ...
            <!--<p><b>Machine Learning, IOT, Web Dev</b></p>-->
            <div class="row" style="padding:0px;">
              <!--<div class="col-md-6">
      ...
      <div class="row" style="padding:0px">
        <div class="col-md-12">
          ...
          <div class="content-box-large box-with-header">
            ...
            <p><b>Recommended Colleges</b></p>
            <div class="row" style="padding:0px;">
              <div class="col-md-6">
                <p><a href="recommended_list.php" class="profile-bt btn btn-default btn-md" style="margin-left: 155px;margin-top: 10px;">VIEW</a></p>
              </div>
            </div>
          </div>
        </div>
	  ...
	  <!--<div class="row" style="padding:0px">
		  		<div class="col-md-12 panel-warning">
		  			<div class="content-box-header panel-heading">
	  					<div class="panel-title ">Field Of Interest</div>
						
						
		  			</div>
		  			<div class="content-box-large box-with-header" style="font-size: medium;">
			  			Machine Learning, IOT, Web dev. 
						<br><br>
					</div>
		  		</div>
		  	</div>
    ...
    <!--  <div class="row" style="padding:0px">
		  		<div class="col-md-12 panel-warning">
		  			...
		  			<div class="content-box-large box-with-header" style="font-size: small;">
