...
$conn=new mysqli($servername,$username2,$password,$database2);
  ...
  $sql2="select n.*,c.* from wishl n,college_info c where n.coll_city like '$loc' and n.degree like '$deg' and n.hsc_rank<=$hsc and n.grad_rank<=$grad and n.gate_rank<=$gate and n.cid=c.cid";
